...
function gamers_hub_customize_register( $wp_customize ) {
   ...
   $wp_customize->add_setting( 'gamers_hub_remove_date', array(
	...
	$wp_customize->add_control( new Gamers_Hub_Toggle_Control( $wp_customize, 'gamers_hub_remove_date', array(
			'label'       => esc_html__( 'Show / Hide Date Option', 'gamers-hub' ),
			'section'     => 'gamers_hub_blog_option',
			'type'        => 'toggle',
			'settings'    => 'gamers_hub_remove_date',
		) ) );
   ...
   $wp_customize->add_setting( 'gamers_hub_remove_author', array(
	...
	$wp_customize->add_control( new Gamers_Hub_Toggle_Control( $wp_customize, 'gamers_hub_remove_author', array(
			'label'       => esc_html__( 'Show / Hide Author Option', 'gamers-hub' ),
			'section'     => 'gamers_hub_blog_option',
			'type'        => 'toggle',
			'settings'    => 'gamers_hub_remove_author',
		) ) );
   ...
   $wp_customize->add_setting( 'gamers_hub_remove_comments', array(
	...
	$wp_customize->add_control( new Gamers_Hub_Toggle_Control( $wp_customize, 'gamers_hub_remove_comments', array(
			'label'       => esc_html__( 'Show / Hide Comment Option', 'gamers-hub' ),
			'section'     => 'gamers_hub_blog_option',
			'type'        => 'toggle',
			'settings'    => 'gamers_hub_remove_comments',
		) ) );
