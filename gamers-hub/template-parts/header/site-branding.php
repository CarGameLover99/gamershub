  ...
  <div class="container">
    <div class="row">
     ...
     <?php if( get_theme_mod( 'gamers_hub_facebook_url' ) != '') { ?>
            ...
            <a <?php if($gamers_hub_header_fb_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'gamers_hub_facebook_url','' ) ); ?>"><i class="fab fa-facebook-f"></i></a>
          <?php } ?>
          <?php if( get_theme_mod( 'gamers_hub_twitter_url' ) != '') { ?>
            <a <?php if($gamers_hub_header_twt_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'gamers_hub_twitter_url','' ) ); ?>"><i class="fab fa-twitter"></i></a>
          <?php } ?>
          <?php if( get_theme_mod( 'gamers_hub_instagram_url' ) != '') { ?>
            <a <?php if($gamers_hub_header_ins_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'gamers_hub_instagram_url','' ) ); ?>"><i class="fab fa-instagram"></i></a>
          <?php } ?>
          <?php if( get_theme_mod( 'gamers_hub_youtube_url' ) != '') { ?>
            <a <?php if($gamers_hub_header_ut_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'gamers_hub_youtube_url','' ) ); ?>"><i class="fab fa-youtube"></i></a>
          <?php } ?>
